...
Step 3: The template generates a README that has a quickstart with all the commands for building, testing, deploying and destorying your stacks! You can look at the [template README](https://github.com/jakejscott/Humidifier/blob/master/templates/Humidifier.Soluition.Template/README.md) if your just reading this on Github to see an example.

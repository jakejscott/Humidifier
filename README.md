...
```powershell
Install-Package Humidifier -Version 0.1.0
Install-Package Humidifier.Json -Version 0.1.0
```

Dotnet CLI
```powershell
dotnet add package Humidifier --version 0.1.0
dotnet add package Humidifier.Json --version 0.1.0
```

...
- [ ] Nuget Package (Humidifier)
- [x] JSON Serialization (Nuget Package Humidifier.Json)
- [ ] YAML Serialization (Nuget Package Humidifier.Yaml)
- [ ] Fn::And
- [ ] Fn::Equals
- [ ] Fn::If
- [ ] Fn::Not
...
- [ ] Conditional intrinsics functions 
- [ ] Build Server

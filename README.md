...
The template generates a README that has a quickstart with all the commands for building, testing, deploying and destroying your stacks. If your reading this on Github, browe to the [template README](https://github.com/jakejscott/Humidifier/blob/master/templates/Humidifier.Solution.Template/README.md) to see what's included.
